...
public class MaterialController {
    ...
    public MaterialController(AccessGuard accessGuard, MaterialRepository materialRepository, JobRepository jobRepository, ActivityService activityService, AiServiceClient aiServiceClient) {
